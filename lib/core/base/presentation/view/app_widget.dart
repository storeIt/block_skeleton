...
//  * In short AppWidget is a common part of the app which provides an easy way to
//  * handle app states and show appropriate widgets based on the app state changes
//  * and a convenient way to test the app.

class AppLayerWidget<T extends BlocBase<BaseState>> extends StatelessWidget {
// class AppWidget extends StatelessWidget {
  AppLayerWidget({required this.childWidget, super.key});
    ...
    return BlocConsumer<T, BaseState>(
      listener: (BuildContext context, BaseState state) {
        if (state.isLoading) {
          ...
          print('log_tag ${this.runtimeType} handle DialogState, show dialog');
          showGeneralDialog(
            context: context,
            pageBuilder: (_, __, ___) => state.dialog!,
